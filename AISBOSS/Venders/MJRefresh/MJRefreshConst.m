...
NSString *const MJRefreshFooterPullToRefresh = @"Reload";
NSString *const MJRefreshFooterReleaseToRefresh = @"Reload";
NSString *const MJRefreshFooterRefreshing = @"Loading...";

NSString *const MJRefreshHeaderPullToRefresh = @"Reload";
NSString *const MJRefreshHeaderReleaseToRefresh = @"Reload";
