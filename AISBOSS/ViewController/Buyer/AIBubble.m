...
{
    self = [super init];
    //@"6c8796",ca9e82 5198ac
    _deepColor = @[@"aa6e28",@"ad2063",@"7e3d60",@"438091",@"936d4c",@"574d71" , @"5f257d",@"162c18",@"6b4a1d",@"4a5679",@"1b1a3a",@"ca9e82",@"6a8e5c",@"",@"",@"",@""];
    _undertoneColor = @[@"cdaf13",@"cf4e5a",@"c3746a", @"6c929f",@"ae9277" ,@"696a9a", @"9c417c", @"32542c", @"aa822a" ,@"7e6479",@"81476a",@"5198ac", @"93a44b",@"",@"",@"",@""];
